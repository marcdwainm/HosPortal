                    ...
                    <div class='archive-table-container'>
                        <div class='archive-table'>
                            ...
                            <div class="archive-table-contents" id='archive-prescription-table'>
                                ...
                                $query = "SELECT * FROM archive_documents WHERE doc_type = 'prescription' LIMIT 0, 5";
                    ...
                    <div class='archive-table-container'>
                        <div class='archive-table'>
                            ...
                            <div class="archive-table-contents" id='archive-labresult-table'>
                                ...
                                $query = "SELECT * FROM archive_documents WHERE doc_type = 'labresult' LIMIT 0, 5";
                                $result = mysqli_query($conn, $query);
                    ...
                    <div class='archive-table-container'>
                        <div class='archive-table'>
                            ...
                            <div class="archive-table-contents" id='archive-soap-table'>
                                ...
                                $query = "SELECT * FROM archive_soap LIMIT 0, 5";
                                $result = mysqli_query($conn, $query);
