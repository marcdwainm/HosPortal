        ...
        <div class='dim'>
            <div class='book-container'>
                ...
                <form class='book-content-doctor' target='dummyframe'>
                    ...
                    <div class='row-0'>
                        <input type='text' class='date-time-input' id='appointment-date-time' name='appointment-date-time' placeholder="Select Date" style = 'border: 1px solid var(--blue);' autocomplete='off'>
                        <div class='app-time'>
                        ...
                        <div class='search-patient'>
                            <input type='text' id='pname-search' placeholder="Patient's Name" style = 'border: 1px solid var(--blue);' autocomplete="off">
                            <div id='plist-search'>
                        ...
                        <input type='text' id='chief-complaint' placeholder='Chief Complaint' style = 'border: 1px solid var(--blue);'autocomplete="off">
                    </div>
                    <div class='row-1'>
                    ...
                    if (mysqli_num_rows($result) > 0) {
                        while ($row = mysqli_fetch_array($result)) {
                            ...
                            if ($status == 'Pending' && $app_type == 'Online') {
                                ...
                                $status_div = "<span class = 'orange-text'>$status</span>";
                                $call_btn = "<button type = 'button' value = '$appointmentnum' class = 'consult-online-nurse'>Rejoin Meeting</button>";
                                $online_btn = "";
