...
$query = "SELECT * FROM appointments WHERE patient_id = '$patientid' AND (status = 'pending' OR status = 'onlinereq' OR status = 'ongoing') ORDER BY UNIX_TIMESTAMP(date_and_time) LIMIT 0, 5";
