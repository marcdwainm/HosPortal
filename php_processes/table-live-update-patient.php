...
$query = "SELECT * FROM appointments WHERE patient_id = '$patientid' AND (status != 'pending' AND status != 'onlinereq' AND status != 'ongoing') ORDER BY UNIX_TIMESTAMP(date_and_time) DESC LIMIT 0, 5";
