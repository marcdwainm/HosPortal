...
$query = "SELECT * FROM archive_other WHERE doc_num = '$restore_id'";
...
$query = "DELETE FROM archive_other WHERE doc_num = '$restore_id'";
mysqli_query($conn, $query);
...
$query = "SELECT * FROM archive_other $like LIMIT 0, 5";
$result = mysqli_query($conn, $query);
